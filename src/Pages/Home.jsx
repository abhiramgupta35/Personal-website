...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 ml-[10%]" data-aos="zoom-in" data-aos-delay="400">
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/8050a29a-b8f6-4d60-9e93-f57ee0d4acb4/nSvd3Ighnv.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 ml-[10%]"
              data-aos="fade-right"
              data-aos-delay="200">
