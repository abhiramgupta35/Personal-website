...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abhiram-a-m-4aa840190?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@_abhiz____",
    icon: Instagram,
    url: "https://www.instagram.com/_abhiz____",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@abhiramgupta35",
    icon: Github,
    url: "https://github.com/abhiramgupta35",
    color: "#ffffff",
